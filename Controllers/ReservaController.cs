...
namespace generacionDeInformes.Controllers
{
    ...
    public class ReservaController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Reserva entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] Reserva entity)
        {
            if (id != entity.ReservaId) return BadRequest();
