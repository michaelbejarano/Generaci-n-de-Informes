...
namespace generacionDeInformes.Controllers
{
    ...
    public class PagoController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Pago entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] Pago entity)
        {
            if (id != entity.PagoId) return BadRequest();
